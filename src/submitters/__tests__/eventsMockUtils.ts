...
/**
 * Function to return a single Mock Event, with the option to randomize some of its data.
 *
 * @param {boolean} isSetMaxSize  Flag to decide to randomize some of the Metadata.
 * @param {boolean} randomize     Flag to decide to randomize some of the Metadata.
 * @returns {string}
 */
 ...
 * @param {boolean} randomize     The flag to set the same random metadata for the events in the list.
